...
function show_vendor_window(vendor_obj)
	...
	local win = {
		...
		draw = function(this)
			...
			local details_top = window_rect.top + 24
			...
			print(vendor_obj.inventory[this.selected_upgrade].cost, details_left,  details_top  + details_line_h * 2, 7)
		end
	}
	window = win
	update_fn = function()
...
function make_hp_pickup(x, y, amount)
	local pickup = make_pickup(x, y, make_animation({9,10}, 16), 10)
	local on_pickup = function(player)
		...
		if obj.type.take_damage ~= nil then
			...
			if obj.hp <= 0 then
				...
				if obj.type ~= player_type then
					...
					elseif rnd(1000) > 500 then
						make_gems_pickup(obj.x,obj.y,1)
					end
					sfx(4)
				end
				return
...
__gff__

...

...

...

...

...


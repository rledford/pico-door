...
vendor_type = {
	...
	update=function(this)
		if player ~= nil and not player.dead and btnp(k_action) and flr(get_range(this, player)) <= TILE_SIZE*2 then
...
0018100000000000000000000000000000000000002ff200002ff20044444444000000000000000000000000000000000000000000000000099aa9900aa99aa0
...


...
player_type = {
	...
	update=function(this)
		...
		if btn(k_shoot) and this.fire_timer <= 0 then
			...
			local proj = make_projectile(this.x, this.y, make_animation({30,31}, 4), this.projectile_dmg, 1.25, dir)
...
__gfx__

